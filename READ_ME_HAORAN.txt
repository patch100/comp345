...
SDL is already included in the package. The C++ files are in /include/, and the .dll files are in the same folder as Main.cpp (comp345/TD1/TD1)
...
Then add the folder that contains all the files (comp345/TD1/TD1).

Then, go to Properties->Linkers->Input-> Additional Dependencies-> Edit, and add : "SDL2.lib;SDL2main.lib;"

All the sdl cpp files are included, so just go to (comp345/TD1/TD1/include) if you want to add them.
